...
function! s:EnableMultiHL()
	...
	vnoremap <silent> ssa :call <SID>DoHighlightCircular(1)<CR>
	nnoremap <silent> ssa :call <SID>DoHighlightCircular(2)<CR>
	vnoremap <silent> ssm :call <SID>ClearOneHighlight(1)<CR>
	nnoremap <silent> ssm :call <SID>ClearOneHighlight(2)<CR>
	nnoremap <silent> ssc :call <SID>ClearAllHighlight()<CR>
endfunction
